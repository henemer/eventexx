...
class TalklistGet(TestCase):
    def setUp(self):
        ...
        c1 = Course.objects.create(title='Título do Curso', start='9:00', description='Descrição do curso.', slots=20)

        speaker = Speaker.objects.create(
            name='Emerson Henning',
            slug='emerson-henning',
            website='https://www.henning.com.br'
        )
    ...
    def test_html(self):
        contents = [
            ...
            (1, '10:00'),
            (1, '13:00'),
            (3, '/palestrantes/emerson-henning'),
            (3, 'Emerson Henning'),
